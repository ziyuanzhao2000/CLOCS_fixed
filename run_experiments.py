...
batch_size_list = [256, 256, 16, 64, 64, 256, 256, 256, 256, 4, 256, 4, 256, 4, 256, 4, 256]#, 512]
...
downstream_dataset_list = ['physionet2017']#,'physionet2020'] #dataset for pretraininng # 'chapman' | 'physionet2020'
second_dataset_list = ['physionet2017']#physionet2020'] #['physionet2020','cardiology','physionet2017','chapman']#,'physionet2020'] #only used for fine-tuning & linear trials #keep as list of empty strings if pretraining
